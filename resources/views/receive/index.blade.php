								...
								<tr>
									<td>
										<div class="form-group">
												...
												<div class="col-md-8">
						                               		 <input type="text" class="form-control" name="product_code" id="product_code" value="" placeholder="Product Code">
						                            		</div>
						                       </div>
									</td>
									<td align="right">
				...
				<table class="table table-striped " id="ctr_totaltbl">
					<tr >
						<div class="form-group">
								...
								<div class="col-md-8" >
										<input type="text" name="subtotal" class="subtotal" value="0" style="text-align: right;">
		                            	</div>
		                       </div>	
					</tr>
					<tr >
						<div class="form-group">
								...
								<div class="col-md-8" >
		                               		<input type="text" name="discount" class="discount" value="0"  style="text-align: right;">
		                            	</div>
		                       </div>	
					</tr>
						<div class="form-group">
								...
								<div class="col-md-8" >
		                               		<input type="text" name="grand_total" class="grand_total" value="0" style="text-align: right;">
		                            	</div>
		                       </div>								
					</tr>
...
function refreshTable(){
	...
	function totalAmount(){
		...
		var d = 0;
		$('.neworderbody tr').each(function(){
			var amt = $(this).find('.amount').val()-0;
			var dis = $(this).find('.dis').val()-0;
			t += amt;
			d += dis;
		});
		g = (t-d);
	...
	$('.add').click(function (e) {
		...
		$.ajaxSetup({
 		...
 		jQuery.ajax({
			...
			url : "http://localhost/laravel5_5_POS/public/receiving/get_product",
			type : "POST",
